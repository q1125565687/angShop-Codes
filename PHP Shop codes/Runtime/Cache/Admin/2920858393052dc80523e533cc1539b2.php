      ...
      <tr>
        ...
        <td>
          <select name="parent_id">
            ...
            <?php if(is_array($cats)): foreach($cats as $key=>$c): ?>//View 调用系统函数： 参数 | ### 代替， 加多个空格
              <option value="<?php echo ($c["cat_id"]); ?>"><?php echo (str_repeat('&nbsp;&nbsp;', $c["lev"])); echo ($c["cat_name"]); ?></option><?php endforeach; endif; ?>
