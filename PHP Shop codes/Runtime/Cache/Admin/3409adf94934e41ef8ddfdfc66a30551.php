...
<link href="/20160608--Exercise/shop/web/Public/Admin/styles/main.css" rel="stylesheet" type="text/css" />
 ...
 <!--引入 ：ueditor 百度编辑器 -->
    ...
    <script charset="utf-8" src="/20160608--Exercise/shop/web/Public/ueditor/ueditor.config.js"></script>
    <script  charset="utf-8" src="/20160608--Exercise/shop/web/Public/ueditor/ueditor.all.min.js"> </script>
    <!--建议手动加在语言，避免在ie下有时因为加载语言失败导致编辑器加载失败-->
    <!--这里加载的语言文件会覆盖你在配置项目里添加的语言类型，比如你在配置项目里配置的是英文，这里加载的中文，那最后就是中文-->
    <script type="text/javascript" charset="utf-8" src="/20160608--Exercise/shop/web/Public/ueditor/lang/zh-cn/zh-cn.js"></script>
    ...
    <div id="tabbody-div">
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/20160608--Exercise/shop/web/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品货号： </td>
          ...
          <tr>
            ...
            <td><select name="cat_id"  ><option value="0">请选择...</option>
              ...
              <option value="14" >&nbsp;&nbsp;&nbsp;&nbsp;移动手机充值卡</option><option value="15" >&nbsp;&nbsp;&nbsp;&nbsp;联通手机充值卡</option><option value="13" >&nbsp;&nbsp;&nbsp;&nbsp;小灵通/固话充值卡</option></select>
             </td>
          </tr>
                   <tr>
...
<!-- id="goods_desc" 名称要一致  -->
            ...
            <script id="goods_desc" style="width:100%; height:400px;"></script>
            </td>
        ...
        <table width="90%" id="mix-table" style="display:none" align="center">
          ...
          <tr>
            <td class="label"><a href="#" title="点击此处查看提示信息"><img src="/20160608--Exercise/shop/web/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商品库存数量：</td>
          ...
          <tr>
            <td class="label">
            <a href="#" title="点击此处查看提示信息"><img src="/20160608--Exercise/shop/web/Public/Admin/images/notice.gif" width="16" height="16" border="0" alt="点击此处查看提示信息"></a> 商家备注： </td>
...
<script>
    ...
    //参数配置文件：ueditor\php\config.json 中，路径等。
...
//配置菜单栏所需功能：定制
    ...
    var ue = UE.getEditor('goods_desc' , uecfg);
