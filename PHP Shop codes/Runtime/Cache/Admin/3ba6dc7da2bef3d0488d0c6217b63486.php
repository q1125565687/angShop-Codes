...
<link href="/20160608--Exercise/shop/web/Public/Admin/styles/general.css" rel="stylesheet" type="text/css" />
<link href="/20160608--Exercise/shop/web/Public/Admin/styles/main.css" rel="stylesheet" type="text/css" />
</head>
<body>
...
<div class="form-div">
  ...
  <form action="" name="searchForm">
    <img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_search.gif" width="26" height="22" border="0" alt="SEARCH" />
...
<table cellpadding="3" cellspacing="1">
  <tr>
    <th>
      ...
      <a href="#">编号</a><img src="/20160608--Exercise/shop/web/Public/Admin/images/sort_desc.gif"/>    </th>
    ...
    <td><input type="checkbox" name="checkboxes[]" value="32" /><?php echo ($g["goods_id"]); ?></td>

    <td class="first-cell" style=""><span ><?php echo ($g["goods_name"]); ?>}</span></td>
    <td><span ><?php echo ($g["goods_sn"]); ?></span></td>
    <td align="right"><span ><?php echo ($g["shop_price"]); ?>
    </span></td>
    <td align="center"><img src="/20160608--Exercise/shop/web/Public/Admin/images/<?php echo ($g[is_on_sale] == 1 ? 'yes' : 'no'); ?>.gif"  /></td>
    <td align="center"><img src="/20160608--Exercise/shop/web/Public/Admin/images/<?php echo ($g[is_on_sale] == 1 ? 'yes' : 'no'); ?>.gif"  /></td>
    <td align="center"><img src="/20160608--Exercise/shop/web/Public/Admin/images/<?php echo ($g[is_on_sale] == 1 ? 'yes' : 'no'); ?>.gif"  /></td>
    <td align="center"><img src="/20160608--Exercise/shop/web/Public/Admin/images/<?php echo ($g[is_on_sale] == 1 ? 'yes' : 'no'); ?>.gif"  /></td>

    <td align="center"><span >100</span></td>
        <td align="right"><span ><?php echo ($g["goods_number"]); ?></span></td>
        <td align="center">
      <a href="#" target="_blank" title="查看"><img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_view.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="编辑"><img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_edit.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="复制"><img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_copy.gif" width="16" height="16" border="0" /></a>
      <a href="<?php echo U('Admin/Goods/del' , array('goods_id'=>$g[goods_id]));?>"  title="回收站"><img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_trash.gif" width="16" height="16" border="0" /></a>
      <a href="#" title="货品列表"><img src="/20160608--Exercise/shop/web/Public/Admin/images/icon_docs.gif" width="16" height="16" border="0" /></a>          </td>
